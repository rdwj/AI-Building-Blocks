...
class LLMInterface:
    """Interface for small model API calls with strict Ansible YAML generation"""
    ...
    def __init__(self, env_file=None):
        ...
        api_url = os.getenv('GRANITE_3_3_8B_INSTRUCT_URL')
        api_key = os.getenv('GRANITE_3_3_8B_INSTRUCT_API_KEY') 
        
        # Validate configuration
        if not api_url or not api_key:
            raise ValueError("GRANITE_3_3_8B_INSTRUCT_URL and GRANITE_3_3_8B_INSTRUCT_API_KEY must be set in .env file")
        
        # Now we can safely assign with type guarantees
